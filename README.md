...
- 대시보드에서 두 선수의 ELOBOARD 상대전적·최근 맞대결 검색
...
중계 서버는 현재 ELOBOARD의 공개 JSON 조회 주소를 사용하며 여자부 주종 계정을 우선합니다. 전적 가져오기는 스폰 경기만 조회하고, 대시보드 상대전적은 ELOBOARD 전체 맞대결 기록을 표시합니다. ELOBOARD가 접속 초과 또는 자동 접근 제한 상태이면 웹앱에서도 해당 오류를 안내합니다.
